...
///
/// ikfast version 0x10000049 generated on 2021-05-30 13:07:21.719173
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
IkReal x49=((1.0)*x2);
eetrans[0]=(((x2*x30))+(((-1.0)*(0.174)*x21))+((x1*(((((-1.0)*x32*x49))+((x2*x31))))))+((x2*x29))+((x20*(((((-1.0)*(0.117)*x27))+(((-1.0)*(0.117)*x26))))))+(((-1.0)*(0.571)*x25))+((x12*(((((-1.0)*x33*x49))+(((-1.0)*x34*x49))))))+(((-1.0)*(0.117)*x21*x24)));
eerot[3]=(((x19*((x38+x42))))+((x0*x37)));
eerot[4]=(((x0*(((((-1.0)*(1.0)*x38))+(((-1.0)*(1.0)*x42))))))+((x19*x37)));
eerot[5]=(((x20*(((((-1.0)*(1.0)*x40))+(((-1.0)*(1.0)*x41))))))+x43);
IkReal x50=((1.0)*x21);
eetrans[1]=(((x21*x29))+((x21*x30))+((x20*(((((-1.0)*(0.117)*x41))+(((-1.0)*(0.117)*x40))))))+(((0.174)*x2))+(((0.117)*x43))+((x12*(((((-1.0)*x33*x50))+(((-1.0)*x34*x50))))))+(((-1.0)*(0.571)*x39))+((x1*(((((-1.0)*x32*x50))+((x21*x31)))))));
eerot[6]=(((x19*x24*((x46+x47))))+((x0*x45)));
eerot[7]=(((x0*x24*x48))+((x19*x45)));
eerot[8]=(x20*x48);
eetrans[2]=((0.181)+(((-1.0)*(0.613)*x3))+(((-1.0)*(0.571)*x13))+((x20*(((((-1.0)*(0.117)*x46))+(((-1.0)*(0.117)*x47))))))+((x1*((x34+x33))))+((x12*((x31+(((-1.0)*(1.0)*x32))))))+(((-1.0)*(0.571)*x15)));
}
...
new_r01=r01;
new_r02=r02;
new_px=(px+(((-1.0)*(0.117)*r02)));
new_r10=r10;
new_r11=r11;
new_r12=r12;
new_py=(py+(((-1.0)*(0.117)*r12)));
new_r20=r20;
new_r21=r21;
new_r22=r22;
new_pz=((-0.181)+(((-1.0)*(0.117)*r22))+pz);
...
int numroots;;
IkReal x68=((0.0025056)*r22);
IkReal x69=((0.0025056)*r21);
IkReal x70=((0.0025056)*r20);
IkReal x71=((0.348)*npz*pz);
IkReal x72=((0.174)*pp*r22);
IkReal x73=((0.348)*npy*pz);
IkReal x74=((0.174)*pp*r21);
IkReal x75=((0.348)*npx*pz);
IkReal x76=((0.174)*pp*r20);
...
IkReal x137=((((-1.0)*gclwh8_2*x136))+((x128*x129))+((x122*x125))+(((-1.0)*x122*x126))+(((-1.0)*x122*x123))+((x120*x121))+(((0.0288)*x87))+(((-1.0)*x127*x132))+(((-1.0)*gclwh10_2*x134))+(((-0.0288)*x84))+(((-1.0)*x120*x127))+((x106*x124))+((pz*x130))+((gclwh6_2*x135))+((x129*x131))+(((-1.0)*x103*x124))+((x100*x124))+(((0.0288)*x81)));
IkReal x138=((0.0288)*x96);
IkReal x139=((0.48)*x98);
IkReal x140=((0.48)*x101);
IkReal x141=((0.48)*x104);
IkReal x142=((0.0288)*x107);
IkReal x143=((0.0288)*x109);
...
IkReal x151=((0.08352)*x79);
IkReal x152=((0.08352)*x82);
IkReal x153=(gclwh4_14*rxp2_2);
IkReal x154=((0.08352)*x153);
IkReal x155=((((-1.0)*x154))+x152+(((-1.0)*x151)));
IkReal x156=((0.27408)*rxp2_2);
IkReal x157=((0.0164448)*r21);
IkReal x158=((0.0164448)*r20);
IkReal x159=(gclwh10_2*npz*pz);
IkReal x160=((1.142)*pp);
IkReal x161=((2.284)*npy*pz);
IkReal x162=((2.284)*npx);
IkReal x163=((1.142)*pp*r20);
IkReal x164=(gclwh11_10*r22);
IkReal x165=((0.0144)*x164);
IkReal x166=(gclwh13_1*rxp1_2);
IkReal x167=(gclwh13_10*rxp1_2);
IkReal x168=((0.24)*x167);
IkReal x169=(gclwh15_1*rxp0_2);
IkReal x170=(gclwh15_10*rxp0_2);
IkReal x171=((0.24)*x170);
IkReal x172=(gclwh5_1*rxp2_2);
IkReal x173=(gclwh5_10*rxp2_2);
IkReal x174=((0.24)*x173);
IkReal x175=(gclwh7_10*r21);
IkReal x176=((0.0144)*x175);
IkReal x177=(gclwh9_10*r20);
IkReal x178=((0.0144)*x177);
IkReal x179=(pp*x175);
...
IkReal x198=(((x120*x191))+((pz*x197))+(((-1.0)*x124*x169))+((x128*x196))+((x124*x166))+(((-1.0)*x132*x195))+(((0.0288)*x188))+((x124*x172))+(((-1.0)*x120*x195))+((x122*x193))+(((-1.0)*x122*x194))+((x131*x196))+((gclwh7_0*x135))+(((-1.0)*x122*x192))+(((-1.0)*gclwh9_0*x136))+(((0.0288)*x190))+(((-1.0)*gclwh11_0*x134))+(((-0.0288)*x189)));
...
IkReal x202=((0.04176)*x201);
IkReal x203=(gclwh15_15*rxp0_2);
IkReal x204=((0.04176)*x203);
...
IkReal x214=((0.08352)*x201);
IkReal x215=((0.08352)*x203);
IkReal x216=(gclwh5_15*rxp2_2);
IkReal x217=((0.08352)*x216);
IkReal x218=((((-1.0)*x215))+x214+x217);
IkReal x219=(gclwh11_0*npz*pz);
IkReal x220=((0.0288)*x164);
IkReal x221=((0.48)*x167);
IkReal x222=((0.48)*x170);
IkReal x223=((0.48)*x173);
IkReal x224=((0.0288)*x175);
IkReal x225=((0.0288)*x177);
...
IkReal x312=((((-1.0)*x302*x310))+(((-1.0)*x132*x304))+(((0.12)*x252))+x122+(((-1.0)*x270*x311))+((x271*x308))+((gclwh3_2*x135))+(((-1.0)*gclwh14_2*x136))+((x275*x308))+(((-1.0)*x284*x309))+(((-1.0)*x122*x299))+(((0.001728)*x244))+(((-1.0)*x292*x309))+(((-0.12)*x258))+((x120*x303))+(((-1.0)*gclwh4_8*x305))+(((-1.0)*x120*x300))+((x128*x302))+((x288*x309))+(((-1.0)*x122*x307))+((gclwh4_2*x134))+(((0.12)*x262))+((gclwh1_2*x136))+((x131*x301))+((x122*x306))+(((-0.001728)*x242))+((gclwh14_8*npx*x122))+(((-1.0)*x132*x300))+(((-1.0)*x132*x303))+((gclwh12_2*x135))+(((-1.0)*gclwh12_8*npy*x122))+(((0.001728)*x239))+(((-1.0)*x297*x309))+(((-1.0)*x120*x304))+((x128*x301))+(((-1.0)*x290*x309))+((x267*x308))+((x272*x308)));
IkReal x313=((((-4.0)*x286))+(((-0.0288)*x265))+(((-2.0)*x283))+(((2.0)*x280))+(((-2.0)*x296))+(((-0.48)*x263))+(((4.0)*x281))+(((-0.0288)*x273))+(((0.0288)*x268))+(((0.48)*x276))+(((-0.48)*x278))+(((4.0)*x294)));
IkReal x314=((0.0050112)*r22);
IkReal x315=((0.696)*npz*pz);
IkReal x316=((0.348)*pp*r22);
IkReal x317=(((gclwh4_14*x315))+(((0.696)*x247))+(((0.348)*x255))+(((-1.0)*gclwh4_14*x314))+(((-0.696)*x253))+(((-0.0050112)*x237))+(((-1.0)*gclwh4_14*x316))+(((0.0050112)*x240))+(((-0.348)*x249)));
IkReal x318=(gclwh12_2*npy*pz);
IkReal x319=(gclwh4_2*npz*pz);
IkReal x320=(gclwh0_1*r20);
IkReal x321=(gclwh11_10*rxp2_2);
IkReal x322=((0.24)*x321);
IkReal x323=(gclwh13_1*r21);
IkReal x324=(gclwh13_10*r21);
IkReal x325=((0.0144)*x324);
IkReal x326=(gclwh15_1*r20);
IkReal x327=(gclwh15_10*r20);
IkReal x328=((0.0144)*x327);
IkReal x329=(gclwh2_1*r21);
IkReal x330=(gclwh5_1*r22);
IkReal x331=(gclwh5_10*r22);
IkReal x332=((0.0144)*x331);
IkReal x333=(gclwh7_10*rxp1_2);
IkReal x334=((0.24)*x333);
IkReal x335=(gclwh9_10*rxp0_2);
IkReal x336=((0.24)*x335);
IkReal x337=(pp*x327);
...
IkReal x369=(pp*pz);
IkReal x370=((((-0.12)*x366))+x122+((x365*x369))+(((-0.001728)*x356))+((x308*x329))+((x309*x340))+((gclwh13_9*npy*x122))+((gclwh0_0*x136))+((x360*x369))+(((0.12)*x363))+((gclwh2_0*x135))+(((-0.001728)*x358))+(((-1.0)*x311*x323))+((x120*x364))+((x309*x351))+((gclwh11_0*rxp2_2*x122))+((x308*x326))+(((-1.0)*x310*x359))+(((-1.0)*x311*x330))+((x128*x359))+(((-1.0)*gclwh15_9*npx*x122))+(((-1.0)*gclwh5_0*x134))+(((0.001728)*x357))+(((-0.12)*x361))+((x122*x368))+(((-1.0)*gclwh13_0*x135))+((x120*x365))+(((-1.0)*x132*x364))+(((-1.0)*x309*x338))+(((-1.0)*x128*x362))+(((-1.0)*x310*x362))+((gclwh15_0*x136))+((gclwh5_9*x305))+(((-1.0)*x309*x345))+((x308*x320))+(((-1.0)*x122*x367))+((x120*x360))+(((-1.0)*x309*x349)));
IkReal x371=((((-1.0)*gclwh11_7*x85))+(((-1.0)*gclwh9_7*x234))+((gclwh7_7*x233)));
IkReal x372=(gclwh11_13*rxp2_2);
IkReal x373=(gclwh13_15*r21);
IkReal x374=((0.0025056)*x373);
IkReal x375=(gclwh15_15*r20);
IkReal x376=((0.0025056)*x375);
IkReal x377=(gclwh5_15*x68);
IkReal x378=(gclwh7_13*rxp1_2);
IkReal x379=(gclwh9_13*rxp0_2);
IkReal x380=(gclwh13_15*npy*pz);
IkReal x381=((0.348)*x380);
IkReal x382=(gclwh13_15*pp*r21);
IkReal x383=((0.174)*x382);
IkReal x384=(gclwh13_9*npy*pz);
IkReal x385=(gclwh15_15*npx*pz);
IkReal x386=((0.348)*x385);
IkReal x387=(gclwh15_15*pp*r20);
IkReal x388=((0.174)*x387);
IkReal x389=(gclwh15_9*npx*pz);
IkReal x390=(gclwh5_15*x71);
IkReal x391=(gclwh5_15*x72);
IkReal x392=(gclwh5_9*npz*pz);
IkReal x393=((0.0340992)*r21);
IkReal x394=((0.0340992)*r20);
IkReal x395=((4.736)*npy*pz);
IkReal x396=((2.368)*pp);
IkReal x397=((4.736)*npx);
IkReal x398=((2.368)*pp*r20);
IkReal x399=((0.0012096)*r21);
IkReal x400=((0.0012096)*r20);
IkReal x401=((0.168)*npy*pz);
IkReal x402=((0.084)*pp);
IkReal x403=((0.168)*npx);
IkReal x404=((0.084)*pp*r20);
op[0]=((((-1.184)*x95))+(((2.368)*x90))+(((-1.184)*x91))+(((0.28416)*x84))+(((-2.368)*x92))+(((-0.28416)*x81))+(((-0.0170496)*x78))+(((2.368)*x94))+x86+x80+(((-1.0)*x83))+(((0.0170496)*x88))+(((-0.0170496)*x89))+x77+(((-0.28416)*x87))+(((1.184)*x93)));
op[1]=(x137+x102+(((-1.0)*x117))+(((-0.34025568)*x100))+(((0.34025568)*x103))+x97+(((-1.0)*x114))+(((-1.0)*x108))+(((-1.0)*x99))+(((-1.0)*x119))+(((-0.34025568)*x106))+(((-1.0)*x105))+x112+x116+x111+x110);
op[2]=((-0.397416)+x150);
op[3]=(x155+(((-1.0)*x127*x160))+(((0.29424)*x87))+(((-2.284)*x159))+(((-1.0)*x129*x162))+((gclwh6_2*x161))+((x121*x160))+(((-0.29424)*x84))+(((-0.27408)*x123))+(((-1.0)*gclwh6_2*x157))+((gclwh8_2*x163))+(((0.29424)*x81))+((gclwh8_2*x158))+(((-1.0)*gclwh4_2*x156))+(((0.0164448)*x121))+(((0.27408)*x125)));
op[4]=((((-0.0006048)*x78))+(((0.084)*x90))+(((0.01008)*x87))+(((0.042)*x93))+(((-1.0)*x80))+(((-1.0)*x86))+x83+(((0.0006048)*x88))+(((-0.084)*x92))+(((-0.0006048)*x89))+(((0.01008)*x81))+x77+(((-0.01008)*x84))+(((-0.042)*x91))+(((0.084)*x94))+(((-0.042)*x95)));
op[5]=(x137+x105+x108+(((-1.0)*x110))+(((-0.0042336)*x100))+(((-1.0)*x97))+(((-1.0)*x111))+x99+(((-1.0)*x116))+(((0.0042336)*x103))+(((-1.0)*x102))+(((-0.0042336)*x106))+(((-1.0)*x112))+x114+x119+x117);
op[6]=((((-1.0)*x171))+(((-0.34025568)*x172))+(((-1.0)*x182))+(((-1.0)*x178))+(((-0.34025568)*x166))+(((-1.0)*x187))+(((-1.0)*x184))+x179+x176+x174+x168+x198+x181+x186+(((-1.0)*x165))+(((0.34025568)*x169)));
op[7]=((((-1.184)*x213))+(((2.368)*x208))+(((-0.0170496)*x200))+(((0.0170496)*x206))+(((-0.0170496)*x207))+(((1.184)*x211))+(((-1.184)*x209))+(((2.368)*x212))+(((-2.368)*x210))+x205+x202+x199+(((-0.28416)*x188))+(((0.28416)*x189))+(((-1.0)*x204))+(((-0.28416)*x190)));
op[8]=((((-1.0)*gclwh7_0*x157))+((x160*x191))+((gclwh7_0*x161))+(((0.27408)*x193))+(((-1.0)*x162*x196))+(((-2.284)*x219))+((gclwh9_0*x158))+(((-0.29424)*x188))+(((-1.0)*x160*x195))+x218+(((0.29424)*x189))+(((-0.27408)*x192))+(((-0.29424)*x190))+((gclwh9_0*x163))+(((0.0164448)*x191))+(((-1.0)*gclwh5_0*x156)));
op[9]=((-0.397416)+x232);
op[10]=((((-1.0)*x174))+(((-1.0)*x168))+(((-1.0)*x186))+(((0.0042336)*x169))+(((-1.0)*x176))+(((-1.0)*x179))+x171+x178+x165+x198+(((-1.0)*x181))+x182+x184+x187+(((-0.0042336)*x166))+(((-0.0042336)*x172)));
op[11]=((((-0.084)*x210))+(((-0.01008)*x189))+(((-0.042)*x209))+(((-0.042)*x213))+(((-0.0006048)*x200))+(((-1.0)*x205))+(((0.01008)*x190))+(((-1.0)*x202))+(((0.0006048)*x206))+(((0.01008)*x188))+x204+x199+(((0.084)*x212))+(((0.084)*x208))+(((0.042)*x211))+(((-0.0006048)*x207)));
op[12]=((((2.368)*x261))+(((-2.368)*x257))+(((-1.184)*x262))+(((-1.0)*x256))+(((0.28416)*x236))+(((-0.0170496)*x239))+(((-1.0)*x259))+(((-1.0)*x248))+x260+(((-1.184)*x252))+(((0.0170496)*x242))+(((-0.0170496)*x244))+x243+(((1.184)*x258))+x254+x250+(((2.368)*x251))+(((-0.28416)*x245))+x235+x238+(((0.28416)*x246))+(((-1.0)*x241)));
op[13]=((-1.432132)+(((-1.403332)*x285))+x295+(((0.0204153408)*x270))+(((-1.432132)*x291))+x269+(((0.0204153408)*x271))+(((1.403332)*x289))+(((2.835464)*x284))+(((2.835464)*x292))+(((-0.0204153408)*x267))+(((2.835464)*x290))+(((-1.0)*x274))+(((-2.835464)*x288))+(((-1.0)*x266))+(((-1.0)*x296))+x277+(((-1.432132)*x293))+(((-1.0)*x279))+(((-1.0)*x264))+(((-1.0)*x283))+x312+(((-0.0204153408)*x275))+(((-1.0)*x287))+(((-1.403332)*x298))+(((0.0204153408)*x272))+x280+x282+(((2.835464)*x297)));
op[14]=((-0.160008)+x313);
op[15]=((((0.0176544)*x239))+(((-0.0164448)*x304))+(((0.0176544)*x244))+((gclwh1_2*x158))+(((1.226)*x252))+(((1.226)*x262))+((x162*x302))+(((-2.452)*x251))+(((2.452)*x257))+(((-1.0)*x162*x301))+(((-0.27408)*x299))+(((-1.0)*x160*x303))+(((-1.0)*x160*x300))+(((-1.0)*x160*x304))+(((2.284)*x319))+(((0.27408)*x306))+(((-0.0164448)*x300))+(((2.284)*x318))+((gclwh14_2*x163))+(((-1.0)*gclwh1_2*x163))+x317+(((-1.226)*x258))+(((-0.0176544)*x242))+((gclwh14_2*x158))+(((-2.452)*x261))+(((-0.27408)*x307))+((gclwh3_2*x161))+((gclwh3_2*x157)));
op[16]=((((-1.0)*x250))+(((-0.042)*x258))+(((-1.0)*x260))+(((0.042)*x252))+(((0.01008)*x246))+x248+x241+(((0.01008)*x236))+(((0.0006048)*x239))+(((-0.0006048)*x242))+(((-1.0)*x243))+x256+x259+(((-0.084)*x261))+(((-1.0)*x238))+(((0.084)*x257))+(((-0.01008)*x245))+(((-1.0)*x254))+(((0.042)*x262))+(((0.0006048)*x244))+x235+(((-0.084)*x251)));
op[17]=((0.03204)+(((-1.0)*x277))+(((-0.00324)*x285))+x296+(((-1.0)*x295))+x264+x266+(((-0.03528)*x288))+(((-0.03204)*x291))+(((0.000254016)*x272))+(((-1.0)*x269))+(((-0.00324)*x298))+(((-0.000254016)*x275))+(((0.03528)*x292))+x279+x274+(((-1.0)*x280))+(((-0.03204)*x293))+(((0.00324)*x289))+x312+(((-1.0)*x282))+(((0.03528)*x297))+x287+x283+(((0.000254016)*x271))+(((-0.000254016)*x267))+(((0.03528)*x290))+(((0.000254016)*x270))+(((0.03528)*x284)));
op[18]=((1.432132)+(((-2.835464)*x340))+(((-1.0)*x348))+(((-0.0204153408)*x326))+(((2.835464)*x349))+(((-1.0)*x332))+(((-1.0)*x344))+x354+(((-1.0)*x322))+(((-1.0)*x325))+x334+x337+(((0.0204153408)*x329))+(((1.403332)*x352))+(((-1.0)*x336))+(((-1.403332)*x346))+x328+(((1.403332)*x341))+(((-1.0)*x355))+(((0.0204153408)*x323))+(((-2.835464)*x351))+(((0.0204153408)*x330))+(((0.0204153408)*x320))+x343+(((2.835464)*x338))+(((-1.432132)*x339))+(((2.835464)*x345))+x370+(((-1.432132)*x350)));
op[19]=((((-1.0)*x386))+x390+(((0.28416)*x378))+(((-1.0)*x374))+(((0.0170496)*x356))+(((-1.0)*x383))+(((-0.28416)*x372))+(((0.0170496)*x358))+x388+x381+(((-2.368)*x392))+(((2.368)*x389))+(((1.184)*x361))+(((-1.0)*x377))+(((-1.184)*x363))+(((-0.28416)*x379))+(((-0.0170496)*x357))+(((-1.0)*x391))+x371+x376+(((-2.368)*x384))+(((1.184)*x366)));
op[20]=((((0.0176544)*x356))+(((-0.348)*x382))+(((-2.284)*gclwh5_0*npz*pz))+(((-1.0)*gclwh15_0*x158))+(((-0.0176544)*x357))+((gclwh5_15*x315))+(((-1.0)*gclwh13_0*x161))+(((-1.0)*gclwh15_0*x163))+((x162*x362))+((gclwh11_0*x156))+(((2.452)*x389))+((x160*x365))+(((-0.696)*x385))+((gclwh0_0*x158))+(((-0.0050112)*x373))+(((-1.0)*x160*x364))+(((-1.226)*x363))+(((-2.452)*x384))+((gclwh2_0*x161))+(((0.348)*x387))+(((0.0050112)*x375))+(((-0.27408)*x367))+(((-1.0)*gclwh5_15*x316))+(((0.0176544)*x358))+(((-1.0)*gclwh5_15*x314))+(((0.0164448)*x365))+(((1.226)*x366))+(((-1.0)*gclwh0_0*x163))+(((1.226)*x361))+(((0.27408)*x368))+((x162*x359))+(((0.696)*x380))+(((-2.452)*x392))+((x160*x360))+((gclwh2_0*x157))+((gclwh13_0*x157)));
op[21]=((-0.160008)+(((-4.0)*x353))+(((2.0)*x344))+(((4.0)*x347))+(((0.48)*x321))+(((0.0288)*x324))+(((-2.0)*x337))+(((-4.0)*x342))+(((0.48)*x335))+(((0.0288)*x331))+(((-0.48)*x333))+(((-0.0288)*x327))+(((2.0)*x355)));
op[22]=((-0.03204)+(((0.000254016)*x330))+(((0.000254016)*x329))+(((-1.0)*x334))+(((-0.000254016)*x326))+(((0.03528)*x338))+(((-1.0)*x328))+(((-1.0)*x343))+(((-1.0)*x354))+(((-0.03528)*x351))+(((-0.03204)*x350))+x355+(((0.00324)*x341))+(((0.00324)*x352))+x336+x332+(((-0.00324)*x346))+x325+x322+(((-0.03204)*x339))+(((-0.03528)*x340))+x344+x348+(((0.000254016)*x320))+(((0.03528)*x349))+x370+(((-1.0)*x337))+(((0.000254016)*x323))+(((0.03528)*x345)));
op[23]=((((-0.01008)*x379))+(((-1.0)*x388))+x391+(((-0.042)*x366))+(((-0.0006048)*x358))+(((0.0006048)*x357))+(((-0.01008)*x372))+(((0.01008)*x378))+x386+x383+(((-0.0006048)*x356))+(((-1.0)*x381))+(((-1.0)*x390))+(((0.042)*x363))+(((-0.042)*x361))+(((0.084)*x384))+x371+x377+x374+(((-0.084)*x389))+(((0.084)*x392))+(((-1.0)*x376)));
op[24]=((-0.824064)+x150);
op[25]=(((gclwh8_2*x398))+(((-0.56832)*x123))+(((-4.736)*x159))+(((-1.0)*x129*x397))+x155+(((0.56832)*x125))+(((-1.0)*gclwh6_2*x393))+(((0.0340992)*x121))+(((-1.0)*x127*x396))+((gclwh6_2*x395))+(((2.368)*x130))+(((-0.56832)*x126))+((gclwh8_2*x394)));
op[26]=((((-4.568)*x90))+(((0.16704)*x82))+(((-0.16704)*x79))+(((0.0328896)*x89))+(((4.568)*x92))+(((-2.284)*x93))+(((-0.16704)*x153))+(((2.284)*x95))+(((0.0328896)*x78))+(((2.284)*x91))+(((-4.568)*x94))+(((-0.0328896)*x88)));
op[27]=((((-8.0)*x115))+(((-4.0)*x112))+(((0.0576)*x107))+(((4.0)*x117))+(((-0.0576)*x109))+(((8.0)*x113))+(((-4.0)*x111))+(((8.0)*x118))+(((0.96)*x98))+(((0.96)*x104))+(((-0.0576)*x96))+(((-0.96)*x101)));
op[28]=((-0.029232)+x139+x147+x148+x141+x142+x144+(((-1.0)*x146))+(((-1.0)*x140))+(((-1.0)*x145))+(((-1.0)*x138))+(((-1.0)*x149))+(((-1.0)*x143)));
op[29]=(((gclwh8_2*x404))+(((-0.168)*x159))+(((-1.0)*x129*x403))+x151+x154+(((-0.02016)*x126))+(((-1.0)*x152))+(((0.0012096)*x121))+((gclwh8_2*x400))+(((-1.0)*x127*x402))+(((-0.02016)*x123))+(((-1.0)*gclwh6_2*x399))+(((0.084)*x130))+((gclwh6_2*x401))+(((0.02016)*x125)));
op[30]=((((-1.0)*x195*x396))+(((-1.0)*x196*x397))+(((-4.736)*x219))+(((0.56832)*x193))+(((-1.0)*gclwh7_0*x393))+(((0.0340992)*x191))+(((-0.56832)*x192))+((gclwh9_0*x398))+(((2.368)*x197))+((gclwh9_0*x394))+x218+(((-0.56832)*x194))+((gclwh7_0*x395)));
op[31]=((-0.824064)+x232);
op[32]=((((-8.0)*x185))+(((-8.0)*x180))+(((0.96)*x170))+(((0.0576)*x177))+(((-0.96)*x173))+(((4.0)*x187))+(((-4.0)*x179))+(((4.0)*x182))+(((-0.96)*x167))+(((0.0576)*x164))+(((8.0)*x183))+(((-0.0576)*x175)));
op[33]=((((-0.16704)*x201))+(((2.284)*x213))+(((-4.568)*x212))+(((-0.16704)*x216))+(((0.0328896)*x207))+(((2.284)*x209))+(((-4.568)*x208))+(((0.0328896)*x200))+(((-0.0328896)*x206))+(((0.16704)*x203))+(((-2.284)*x211))+(((4.568)*x210)));
op[34]=((((-1.0)*x214))+(((-1.0)*x196*x403))+((gclwh9_0*x400))+(((-1.0)*x217))+(((-0.168)*x219))+(((-1.0)*x195*x402))+((gclwh9_0*x404))+(((0.0012096)*x191))+x215+(((0.02016)*x193))+(((-0.02016)*x194))+(((-1.0)*gclwh7_0*x399))+((gclwh7_0*x401))+(((0.084)*x197))+(((-0.02016)*x192)));
op[35]=((-0.029232)+(((-1.0)*x231))+(((-1.0)*x220))+(((-1.0)*x225))+(((-1.0)*x228))+(((-1.0)*x227))+x226+x221+x224+x223+x229+(((-1.0)*x222))+x230);
op[36]=((2.74316)+x313);
op[37]=(((x302*x397))+(((-0.0340992)*x304))+((gclwh3_2*x395))+(((0.56832)*x306))+(((-0.56832)*x299))+(((-1.0)*x301*x397))+(((4.736)*x318))+((gclwh3_2*x393))+(((-1.0)*gclwh1_2*x398))+(((4.736)*x319))+x317+(((-0.0340992)*x300))+(((-1.0)*x303*x396))+(((-1.0)*x300*x396))+((gclwh14_2*x398))+((gclwh1_2*x394))+((gclwh14_2*x394))+(((-0.56832)*x307))+(((-1.0)*x304*x396)));
...
IkReal x428=(pp*x420);
IkReal x429=((((-4.0)*x427))+(((4.0)*x425))+(((0.0288)*x418))+(((-0.48)*x421))+(((-4.0)*x423))+(((0.0288)*x420))+(((-2.0)*x426))+(((2.0)*x428))+(((0.48)*x422))+(((0.48)*x417))+(((2.0)*x424))+(((-0.0288)*x419)));
IkReal x430=((((0.348)*x416))+(((-0.696)*x415))+(((0.0050112)*x408))+(((0.348)*x412))+(((-0.0050112)*x407))+(((-0.696)*x411))+(((0.696)*x413))+(((-0.348)*x414))+(((0.0050112)*x406)));
...
IkReal x436=((0.0012096)*r22);
IkReal x437=((0.02016)*rxp1_2);
IkReal x438=((0.02016)*rxp0_2);
IkReal x439=(gclwh12_2*npy*pz);
IkReal x440=((0.084)*pp);
IkReal x441=(gclwh14_2*npx*pz);
IkReal x442=(gclwh1_2*npx*pz);
IkReal x443=(gclwh3_2*npy*pz);
IkReal x444=((0.168)*npz*pz);
...
IkReal x507=((0.0025056)*r22);
IkReal x508=((0.0025056)*r21);
IkReal x509=((0.0025056)*r20);
IkReal x510=((0.348)*npz*pz);
IkReal x511=((0.174)*pp*r22);
IkReal x512=((0.348)*npy*pz);
IkReal x513=((0.174)*pp*r21);
IkReal x514=((0.348)*npx*pz);
IkReal x515=((0.174)*pp*r20);
IkReal x516=x77;
IkReal x517=(gclwh10_12*r22);
IkReal x518=(gclwh12_14*rxp1_2);
IkReal x519=((0.04176)*x518);
IkReal x520=(gclwh12_8*rxp1_2);
IkReal x521=(gclwh14_14*rxp0_2);
IkReal x522=((0.04176)*x521);
IkReal x523=(gclwh14_8*rxp0_2);
IkReal x524=((0.04176)*rxp2_2);
...
IkReal x558=(pp*x548);
IkReal x559=((0.0144)*pz);
IkReal x560=(gclwh10_2*r22);
IkReal x561=((0.24)*pz*rxp1_2);
IkReal x562=((0.24)*pp);
IkReal x563=((0.24)*pz*rxp0_2);
IkReal x564=((0.24)*pz*rxp2_2);
...
IkReal x573=((((-1.0)*gclwh12_2*x561))+((x560*x567))+(((-1.0)*x542*x562))+(((-0.0288)*x523))+(((-1.0)*x559*x565))+(((0.0288)*x520))+(((-1.0)*gclwh8_2*x572))+(((-1.0)*x565*x568))+((x559*x566))+((x539*x562))+((x566*x567))+(((0.0288)*x526))+((gclwh14_2*x563))+(((-1.0)*gclwh10_2*x570))+((gclwh6_2*x571))+(((-1.0)*gclwh4_2*x564))+((x545*x562))+((x559*x560)));
IkReal x574=((0.0164448)*r22);
IkReal x575=((0.27408)*rxp1_2);
IkReal x576=((0.27408)*rxp0_2);
IkReal x577=((0.08352)*rxp2_2);
IkReal x578=((0.27408)*rxp2_2);
IkReal x579=((0.0164448)*r21);
IkReal x580=((0.0164448)*r20);
IkReal x581=((2.284)*npz*pz);
IkReal x582=((1.142)*pp);
IkReal x583=((2.284)*npy*pz);
IkReal x584=((2.284)*npx*pz);
IkReal x585=(gclwh11_10*r22);
IkReal x586=((0.0144)*x585);
IkReal x587=(gclwh13_1*rxp1_2);
IkReal x588=(gclwh13_10*rxp1_2);
IkReal x589=((0.24)*x588);
IkReal x590=(gclwh15_1*rxp0_2);
IkReal x591=(gclwh15_10*rxp0_2);
IkReal x592=((0.24)*x591);
IkReal x593=(gclwh5_1*rxp2_2);
IkReal x594=(gclwh5_10*rxp2_2);
IkReal x595=((0.24)*x594);
IkReal x596=(gclwh7_10*r21);
IkReal x597=((0.0144)*x596);
IkReal x598=(gclwh9_10*r20);
IkReal x599=((0.0144)*x598);
IkReal x600=(pp*x585);
IkReal x601=(pp*x598);
...
IkReal x615=((((-1.0)*x559*x613))+((gclwh15_0*x563))+(((-1.0)*gclwh13_0*x561))+(((-1.0)*gclwh11_0*x570))+((x562*x593))+(((0.0288)*x609))+((x559*x612))+(((-1.0)*gclwh5_0*x564))+((gclwh7_0*x571))+((x559*x614))+((x567*x614))+((x567*x612))+(((0.0288)*x611))+(((-1.0)*gclwh9_0*x572))+(((-1.0)*x568*x613))+(((-1.0)*x562*x590))+(((-0.0288)*x610))+((x562*x587)));
IkReal x616=x199;
IkReal x617=(gclwh11_13*r22);
IkReal x618=(gclwh13_15*rxp1_2);
IkReal x619=((0.04176)*x618);
IkReal x620=(gclwh15_15*rxp0_2);
IkReal x621=((0.04176)*x620);
...
IkReal x676=((0.24)*pz);
IkReal x677=((0.24)*npz*pz);
IkReal x678=pp*pp;
IkReal x679=((2.0)*pp);
IkReal x680=((1.0)*x678);
IkReal x681=((((-0.12)*x647))+((gclwh6_2*x561))+((x667*x679))+(((-1.0)*x435*x568))+(((-1.0)*gclwh4_8*x677))+((x433*x567))+((x658*x678))+(((-1.0)*x669*x679))+((gclwh3_2*x571))+(((-1.0)*x432*x568))+(((-1.0)*x445*x559))+(((0.12)*x651))+((x434*x559))+(((-1.0)*x671*x679))+(((-1.0)*x432*x559))+(((-1.0)*gclwh8_2*x563))+(((0.12)*x643))+((x435*x559))+((x433*x559))+(((0.001728)*x635))+((gclwh14_8*npx*x676))+(((-1.0)*gclwh12_8*npy*x676))+((gclwh4_2*x570))+(((-1.0)*x656*x680))+((x660*x678))+(((-1.0)*x445*x568))+(((-1.0)*x664*x679))+(((-1.0)*gclwh14_2*x572))+((x654*x678))+(((-1.0)*x674*x679))+(((-1.0)*x434*x568))+(((0.001728)*x639))+(((-1.0)*x431*x676))+x676+((x657*x678))+(((-0.001728)*x637))+((gclwh1_2*x572))+((gclwh12_2*x571)));
IkReal x682=(gclwh0_1*r20);
IkReal x683=((0.24)*x478);
IkReal x684=(gclwh13_1*r21);
IkReal x685=((0.0144)*x480);
IkReal x686=(gclwh15_1*r20);
IkReal x687=((0.0144)*x482);
IkReal x688=(gclwh2_1*r21);
IkReal x689=(gclwh5_1*r22);
IkReal x690=((0.0144)*x484);
IkReal x691=((0.24)*x486);
IkReal x692=((0.24)*x488);
...
IkReal x712=(((gclwh2_0*x571))+(((-1.0)*x680*x689))+(((-0.12)*x709))+(((-1.0)*x679*x693))+(((-1.0)*x454*x568))+((x454*x559))+((gclwh0_0*x572))+((x455*x567))+(((-1.0)*x680*x684))+(((-1.0)*gclwh15_9*npx*x676))+((x678*x686))+(((-1.0)*x458*x676))+((x455*x559))+((gclwh5_9*x677))+((x678*x688))+((x448*x567))+(((-1.0)*gclwh13_0*x571))+(((0.12)*x710))+(((-1.0)*x451*x568))+(((-0.001728)*x706))+(((-1.0)*x679*x698))+((x447*x676))+((x459*x676))+((gclwh13_9*npy*x676))+((x446*x559))+(((-0.12)*x711))+((x448*x559))+(((-1.0)*x451*x559))+(((-0.001728)*x708))+(((-1.0)*pz*x461))+((x679*x695))+((gclwh15_0*x572))+((x678*x682))+x676+(((-1.0)*gclwh5_0*x570))+((x679*x703))+(((-1.0)*x679*x701))+(((0.001728)*x707)));
IkReal x713=x371;
IkReal x714=((0.0025056)*x449);
IkReal x715=((0.0025056)*x452);
IkReal x716=(gclwh5_15*x507);
IkReal x717=((0.348)*x464);
IkReal x718=((0.174)*x466);
IkReal x719=(gclwh13_9*npy*pz);
IkReal x720=((0.348)*x469);
IkReal x721=((0.174)*x471);
IkReal x722=(gclwh15_9*npx*pz);
IkReal x723=(gclwh5_15*x510);
IkReal x724=((0.174)*x476);
IkReal x725=(gclwh5_9*npz*pz);
op[38]=((((-0.696)*x412))+(((0.54816)*x409))+(((-0.0100224)*x408))+(((-0.54816)*x410))+(((-0.54816)*x405))+(((0.696)*x414))+(((0.0100224)*x407))+(((-0.696)*x416))+(((-0.0100224)*x406))+(((1.392)*x411))+(((-1.392)*x413))+(((1.392)*x415)));
op[39]=((-0.077808)+(((4.0)*x428))+(((4.0)*x424))+(((-0.0576)*x419))+(((0.0576)*x418))+(((0.96)*x422))+(((0.0576)*x420))+(((-0.96)*x421))+(((0.96)*x417))+(((-8.0)*x427))+(((-4.0)*x426))+(((8.0)*x425))+(((-8.0)*x423)));
op[40]=((0.057024)+x429);
op[41]=((((-1.0)*gclwh8_2*x438))+(((0.0012096)*x433))+(((0.0012096)*x434))+((gclwh4_2*x444))+((x433*x440))+(((-0.0012096)*x432))+(((0.168)*x443))+(((0.168)*x442))+(((-1.0)*x435*x440))+(((-1.0)*x432*x440))+(((-1.0)*gclwh4_2*x436))+(((-0.02016)*x431))+x430+(((-0.168)*x441))+(((0.168)*x439))+((gclwh6_2*x437))+(((-1.0)*x440*x445))+(((-1.0)*x434*x440))+(((0.0012096)*x435)));
op[42]=(x472+x475+(((-1.0)*x470))+(((4.736)*x473))+(((-1.0)*x450))+(((0.0340992)*x454))+(((-1.0)*x477))+(((-4.736)*x462))+((x448*x463))+(((4.736)*x468))+(((-1.0)*x457))+(((-1.0)*x454*x463))+(((-1.0)*x451*x463))+(((4.736)*x460))+(((-0.0340992)*x451))+(((-4.736)*gclwh5_0*npz*pz))+x453+(((-1.0)*x467))+(((0.56832)*x447))+(((0.0340992)*x448))+(((-2.368)*x461))+(((-0.56832)*x458))+((x455*x463))+(((0.56832)*x459))+x465+(((0.0340992)*x455))+(((0.0340992)*x446)));
op[43]=((2.74316)+(((-1.0)*x491))+x479+(((-1.0)*x483))+(((-1.0)*x497))+x501+(((-1.0)*x499))+(((-1.0)*x487))+x489+x481+x485+x495+x493);
op[44]=((0.077808)+(((-8.0)*x498))+(((0.96)*x478))+(((8.0)*x494))+(((-8.0)*x490))+(((4.0)*x500))+(((-0.96)*x486))+(((-4.0)*x496))+(((0.0576)*x484))+(((-0.0576)*x482))+(((0.96)*x488))+(((4.0)*x492))+(((0.0576)*x480)));
op[45]=((((0.54816)*x502))+(((1.392)*x469))+(((0.0100224)*x456))+(((0.696)*x466))+(((-0.54816)*x503))+(((0.0100224)*x449))+(((-0.0100224)*x452))+(((0.54816)*x504))+(((-0.696)*x471))+(((-1.392)*x464))+(((-1.392)*x474))+(((0.696)*x476)));
op[46]=((((-1.0)*x440*x451))+x505+(((-0.168)*x462))+(((0.168)*x460))+((gclwh9_0*x438))+((gclwh5_0*x436))+(((-1.0)*gclwh5_0*x444))+(((0.02016)*x447))+((x440*x448))+(((0.168)*x468))+(((-1.0)*gclwh7_0*x437))+(((-0.084)*x461))+(((0.0012096)*x446))+(((0.168)*x473))+(((0.0012096)*x448))+((x440*x455))+(((0.0012096)*x454))+(((-0.0012096)*x451))+(((-1.0)*x440*x454)));
op[47]=((0.057024)+x506);
op[48]=((((-1.0)*x519))+(((-2.368)*x529))+(((1.184)*x530))+(((2.368)*x531))+(((0.28416)*x523))+(((-1.0)*x525))+(((-1.184)*x532))+(((-2.368)*x533))+(((1.184)*x534))+(((-0.0170496)*x527))+(((-0.28416)*x520))+(((0.0170496)*x517))+x516+(((0.0170496)*x528))+(((-0.28416)*x526))+x522);
op[49]=(x538+(((-1.0)*x536))+x573+(((-1.0)*x549))+(((-0.34025568)*x539))+(((0.34025568)*x542))+x550+x557+x552+(((-1.0)*x558))+(((-1.0)*x541))+(((-1.0)*x553))+(((-1.0)*x555))+(((-0.34025568)*x545))+x544+x547);
op[50]=((0.397416)+(((0.0288)*x546))+(((0.48)*x543))+(((-2.0)*x553))+(((-0.48)*x540))+(((2.0)*x550))+(((-0.0288)*x535))+(((0.48)*x537))+(((4.0)*x551))+(((-2.0)*x558))+(((4.0)*x556))+(((-4.0)*x554))+(((-0.0288)*x548)));
op[51]=((((0.08352)*x518))+((gclwh4_2*x578))+(((-1.0)*gclwh14_2*x576))+(((-0.08352)*x521))+(((-1.0)*gclwh10_2*x574))+(((-1.0)*x560*x582))+((gclwh4_14*x577))+((x565*x582))+(((0.29424)*x526))+((gclwh6_2*x579))+((gclwh8_2*x584))+(((-1.0)*x566*x582))+(((-0.29424)*x523))+((gclwh10_2*x581))+(((0.29424)*x520))+(((-1.0)*gclwh6_2*x583))+(((-1.0)*gclwh8_2*x580))+((gclwh12_2*x575)));
op[52]=((((0.0006048)*x528))+(((0.042)*x534))+(((0.01008)*x526))+(((-1.0)*x522))+(((0.042)*x530))+(((-0.01008)*x523))+(((0.01008)*x520))+(((-0.0006048)*x527))+(((-0.042)*x532))+(((0.084)*x531))+(((-0.084)*x529))+x519+x516+(((-0.084)*x533))+x525+(((0.0006048)*x517)));
op[53]=(x536+(((-0.0042336)*x545))+(((0.0042336)*x542))+x573+(((-1.0)*x544))+(((-0.0042336)*x539))+(((-1.0)*x557))+x555+x558+x553+(((-1.0)*x550))+(((-1.0)*x552))+(((-1.0)*x547))+(((-1.0)*x538))+x549+x541);
op[54]=(x615+(((-0.34025568)*x593))+(((-1.0)*x603))+(((-0.34025568)*x587))+(((-1.0)*x606))+(((-1.0)*x589))+(((0.34025568)*x590))+(((-1.0)*x597))+x586+(((-1.0)*x595))+x599+x592+(((-1.0)*x608))+x600+x601+x605);
op[55]=(x616+(((-1.0)*x622))+(((0.0170496)*x617))+(((1.184)*x626))+(((1.184)*x630))+(((-0.0170496)*x623))+x621+(((-0.28416)*x611))+(((2.368)*x627))+(((0.28416)*x610))+(((-2.368)*x625))+(((-1.184)*x628))+(((-1.0)*x619))+(((-2.368)*x629))+(((0.0170496)*x624))+(((-0.28416)*x609)));
op[56]=((((-1.0)*gclwh15_0*x576))+((gclwh9_0*x584))+((x582*x613))+(((-1.0)*gclwh5_15*x577))+(((-0.29424)*x611))+(((-1.0)*x582*x614))+(((-1.0)*gclwh11_0*x574))+((gclwh13_0*x575))+((gclwh7_0*x579))+(((-1.0)*x582*x612))+(((-0.29424)*x609))+((gclwh11_0*x581))+((gclwh5_0*x578))+(((-1.0)*gclwh7_0*x583))+(((0.08352)*x620))+(((0.29424)*x610))+(((-0.08352)*x618))+(((-1.0)*gclwh9_0*x580)));
op[57]=((0.397416)+(((0.48)*x588))+(((-2.0)*x600))+(((-2.0)*x601))+(((0.48)*x594))+(((-0.0288)*x598))+(((-0.48)*x591))+(((-4.0)*x604))+(((4.0)*x607))+(((-0.0288)*x585))+(((4.0)*x602))+(((0.0288)*x596))+(((2.0)*x606)));
op[58]=((((-1.0)*x592))+x615+(((-1.0)*x600))+(((-1.0)*x599))+(((-1.0)*x601))+(((-0.0042336)*x587))+(((-0.0042336)*x593))+x589+x595+x597+x603+x608+x606+(((0.0042336)*x590))+(((-1.0)*x605))+(((-1.0)*x586)));
op[59]=(x616+x619+(((-0.084)*x625))+(((-0.01008)*x610))+(((-0.084)*x629))+(((-1.0)*x621))+(((0.0006048)*x624))+x622+(((0.0006048)*x617))+(((0.042)*x630))+(((-0.042)*x628))+(((0.01008)*x609))+(((0.042)*x626))+(((0.084)*x627))+(((0.01008)*x611))+(((-0.0006048)*x623)));
op[60]=((((2.368)*x642))+(((-0.0170496)*x635))+(((-1.0)*x644))+(((0.28416)*x409))+(((-1.0)*x641))+(((-0.0170496)*x639))+(((-0.28416)*x410))+(((2.368)*x650))+(((-0.28416)*x405))+x633+x636+(((0.0170496)*x637))+(((-1.184)*x651))+(((-2.368)*x646))+(((-1.0)*x638))+(((1.184)*x647))+(((-1.0)*x634))+x648+x640+x645+(((-1.184)*x643))+(((-1.0)*x649)));
op[61]=((1.432132)+(((1.403332)*x668))+(((-0.0204153408)*x654))+(((-1.432132)*x670))+(((-2.835464)*x667))+(((0.0204153408)*x657))+(((-1.403332)*x665))+(((2.835464)*x664))+x428+x424+(((2.835464)*x671))+(((-1.0)*x661))+x659+x652+x653+(((-1.0)*x426))+(((-1.0)*x663))+(((-1.0)*x673))+(((-1.403332)*x675))+(((2.835464)*x674))+x666+x662+(((0.0204153408)*x656))+(((-1.0)*x655))+(((-1.432132)*x672))+(((0.0204153408)*x658))+x681+(((2.835464)*x669))+(((-0.0204153408)*x660)));
op[62]=((0.160008)+x429);
op[63]=((((-2.284)*x443))+(((1.226)*x643))+(((-0.0176544)*x637))+((x432*x582))+(((-0.0164448)*x435))+(((-1.0)*gclwh6_2*x575))+(((-1.0)*x433*x582))+(((-0.0164448)*x433))+(((0.27408)*x431))+(((-0.0164448)*x434))+(((-1.226)*x647))+((x435*x582))+(((1.226)*x651))+((x445*x582))+((x434*x582))+(((0.0176544)*x639))+(((-2.452)*x650))+((gclwh4_2*x574))+(((2.452)*x646))+(((0.0176544)*x635))+(((-2.284)*x442))+((gclwh8_2*x576))+x430+(((-2.284)*x439))+(((-1.0)*gclwh4_2*x581))+(((-2.452)*x642))+(((0.0164448)*x432))+(((2.284)*x441)));
op[64]=((((-1.0)*x645))+(((-0.084)*x642))+(((-0.01008)*x410))+(((0.0006048)*x635))+x638+x633+x634+(((-0.084)*x650))+(((0.042)*x643))+(((-1.0)*x636))+(((0.0006048)*x639))+(((0.01008)*x409))+(((-0.01008)*x405))+(((0.084)*x646))+(((-0.0006048)*x637))+x649+x641+x644+(((0.042)*x651))+(((-0.042)*x647))+(((-1.0)*x648))+(((-1.0)*x640)));
op[65]=((-0.03204)+(((-1.0)*x659))+(((0.000254016)*x657))+(((-1.0)*x424))+(((-1.0)*x652))+(((0.000254016)*x656))+(((-1.0)*x666))+(((0.000254016)*x658))+(((-0.03204)*x672))+(((-0.00324)*x675))+x426+(((-0.000254016)*x660))+(((-0.03204)*x670))+(((0.03528)*x669))+(((0.03528)*x664))+x655+(((-1.0)*x662))+(((-0.03528)*x667))+(((-0.000254016)*x654))+(((-0.00324)*x665))+(((-1.0)*x653))+x663+x661+(((0.03528)*x671))+(((-1.0)*x428))+x673+x681+(((0.03528)*x674))+(((0.00324)*x668)));
op[66]=((-1.432132)+(((0.0204153408)*x688))+(((-0.0204153408)*x686))+(((1.403332)*x696))+(((0.0204153408)*x682))+(((-1.0)*x697))+(((0.0204153408)*x684))+(((-1.0)*x687))+x500+(((-1.0)*x691))+(((2.835464)*x701))+(((-1.432132)*x694))+(((-1.432132)*x702))+x700+x712+x692+x690+(((2.835464)*x698))+(((-2.835464)*x695))+(((-2.835464)*x703))+(((-1.0)*x496))+(((-1.403332)*x699))+(((2.835464)*x693))+x685+x683+x492+(((-1.0)*x705))+(((0.0204153408)*x689))+(((1.403332)*x704)));
op[67]=((((1.184)*x711))+(((-0.0170496)*x707))+(((-1.0)*x721))+(((0.28416)*x502))+(((-2.368)*x719))+(((-1.0)*x723))+(((0.0170496)*x706))+(((0.28416)*x504))+(((-2.368)*x725))+(((2.368)*x722))+(((-1.0)*x715))+(((0.0170496)*x708))+(((-1.184)*x710))+x714+x716+x713+x718+(((1.184)*x709))+(((-0.28416)*x503))+(((-1.0)*x717))+x720+x724);
op[68]=((((-0.0164448)*x448))+(((-1.0)*gclwh5_0*x574))+(((0.0176544)*x706))+(((1.226)*x709))+(((1.226)*x711))+(((-0.0176544)*x707))+(((2.284)*x462))+((gclwh7_0*x575))+x505+(((2.452)*x722))+((x451*x582))+(((0.0164448)*x451))+(((-2.452)*x719))+(((-2.284)*x468))+((x454*x582))+(((-1.0)*x455*x582))+(((-2.284)*x473))+((gclwh5_0*x581))+(((-2.284)*x460))+(((-0.0164448)*x454))+(((1.142)*x461))+(((-2.452)*x725))+(((-1.0)*x448*x582))+(((-1.0)*gclwh9_0*x576))+(((-0.27408)*x447))+(((0.0176544)*x708))+(((-1.226)*x710))+(((-0.0164448)*x446)));
op[69]=((0.160008)+x506);
op[70]=((0.03204)+(((-1.0)*x700))+(((0.03528)*x701))+(((-0.00324)*x699))+(((0.000254016)*x684))+(((0.03528)*x693))+(((0.00324)*x696))+(((-0.03528)*x703))+(((-0.000254016)*x686))+(((0.000254016)*x682))+(((-0.03204)*x702))+(((0.00324)*x704))+(((-1.0)*x692))+(((0.000254016)*x688))+(((0.03528)*x698))+(((-1.0)*x685))+(((0.000254016)*x689))+(((-1.0)*x690))+(((-1.0)*x492))+(((-0.03204)*x694))+x705+x712+x691+x697+(((-1.0)*x500))+(((-0.03528)*x695))+x687+x496+(((-1.0)*x683)));
op[71]=((((0.0006048)*x707))+(((-0.0006048)*x706))+(((0.042)*x710))+(((-0.084)*x722))+(((-0.042)*x711))+(((-1.0)*x724))+(((-1.0)*x714))+(((-1.0)*x718))+(((-0.01008)*x503))+(((0.01008)*x504))+(((-0.042)*x709))+(((0.084)*x719))+(((0.084)*x725))+x717+x715+x713+(((-0.0006048)*x708))+(((-1.0)*x716))+x723+x721+(((0.01008)*x502))+(((-1.0)*x720)));
...
IkReal x814=((0.12)*cj5);
IkReal x815=((0.12)*sj5);
IkReal x816=((0.613)*cj1);
IkReal x817=((0.571)*cj1*cj2);
IkReal x818=(sj1*sj2);
...
evalcond[2]=((((-1.0)*r00*x815))+(((-1.0)*(1.0)*px))+((x808*x817))+(((-1.0)*r01*x814))+(((-0.174)*x812))+(((-0.571)*x819))+((x808*x816)));
evalcond[3]=((((-1.0)*r11*x814))+(((-1.0)*r10*x815))+(((-1.0)*(1.0)*py))+(((-0.571)*x820))+((x812*x816))+(((0.174)*x808))+((x812*x817)));
...
IkReal x913=((0.12)*cj5);
IkReal x914=((0.12)*sj5);
IkReal x915=((0.613)*cj1);
IkReal x916=((0.571)*cj1*cj2);
IkReal x917=(sj1*sj2);
...
evalcond[2]=((((-1.0)*(1.0)*px))+(((-1.0)*r01*x913))+((x907*x916))+(((-0.571)*x918))+(((-1.0)*r00*x914))+((x907*x915))+(((-0.174)*x911)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-0.571)*x919))+((x911*x916))+(((-1.0)*r11*x913))+(((-1.0)*r10*x914))+((x911*x915))+(((0.174)*x907)));
...
IkReal x983=((0.12)*cj5);
IkReal x984=((0.12)*sj5);
IkReal x985=((0.613)*cj1);
IkReal x986=((0.571)*cj1*cj2);
...
evalcond[6]=(((x963*x985))+(((-1.0)*(1.0)*px))+((x963*x986))+(((-1.0)*r01*x983))+(((-0.174)*x966))+(((-1.0)*r00*x984))+(((-0.571)*x971)));
evalcond[7]=((((-1.0)*(1.0)*py))+((x966*x985))+((x966*x986))+(((-1.0)*r10*x984))+(((-1.0)*r11*x983))+(((0.174)*x963))+(((-0.571)*x976)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1036=((0.12)*sj5);
IkReal x1037=((0.613)*cj1);
IkReal x1038=((0.571)*cj1*cj2);
...
evalcond[6]=((((-1.0)*(1.0)*px))+(((-1.0)*r00*x1036))+((x1015*x1037))+(((-1.0)*r01*x1035))+((x1015*x1038))+(((-0.571)*x1023))+(((-0.174)*x1018)));
evalcond[7]=((((-1.0)*(1.0)*py))+(((-1.0)*r11*x1035))+((x1018*x1038))+(((0.174)*x1015))+(((-1.0)*r10*x1036))+((x1018*x1037))+(((-0.571)*x1028)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
_nj5 = 2;
CheckValue<IkReal> x1041 = IKatan2WithCheck(IkReal(((-1.0)*(((0.12)*r21)))),IkReal(((-1.0)*(((0.12)*r20)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1041.valid){
continue;
}
IkReal x1039=((-1.0)*(x1041.value));
if((((((0.0144)*(r21*r21)))+(((0.0144)*(r20*r20))))) < -0.00001)
continue;
CheckValue<IkReal> x1042=IKPowWithIntegerCheck(IKabs(IKsqrt(((((0.0144)*(r21*r21)))+(((0.0144)*(r20*r20)))))),-1);
if(!x1042.valid){
continue;
}
if( (((-1.0)*(x1042.value)*(((((-1.0)*(0.613)*sj1))+(((-1.0)*(1.0)*pz))+(((-1.0)*(0.571)*cj2*sj1))+(((-1.0)*(0.571)*cj1*sj2)))))) < -1-IKFAST_SINCOS_THRESH || (((-1.0)*(x1042.value)*(((((-1.0)*(0.613)*sj1))+(((-1.0)*(1.0)*pz))+(((-1.0)*(0.571)*cj2*sj1))+(((-1.0)*(0.571)*cj1*sj2)))))) > 1+IKFAST_SINCOS_THRESH )
    continue;
IkReal x1040=IKasin(((-1.0)*(x1042.value)*(((((-1.0)*(0.613)*sj1))+(((-1.0)*(1.0)*pz))+(((-1.0)*(0.571)*cj2*sj1))+(((-1.0)*(0.571)*cj1*sj2))))));
...
j0eval[0]=((7.16531933719434)+(((-14.0775016087516)*x1051))+(((14.0775016087516)*x1052))+x1049+(((-6.55648729086229)*x1050))+(((-13.1129745817246)*x1053))+(((13.1129745817246)*x1054)));
j0eval[1]=IKsign(((89079.25)+(((-81510.25)*x1050))+(((-175011.5)*x1051))+(((175011.5)*x1052))+(((163020.5)*x1054))+(((12432.0)*x1049))+(((-163020.5)*x1053))));
...
IkReal x1067=((500.0)*px);
IkReal x1068=((306.5)*cj1);
IkReal x1069=(cj5*r01);
IkReal x1070=(r00*sj5);
IkReal x1071=((225.5)*cj1*cj2);
IkReal x1072=((225.5)*sj1*sj2);
CheckValue<IkReal> x1073=IKPowWithIntegerCheck(((((-87.0)*x1065))+(((87.0)*x1066))),-1);
if(!x1073.valid){
continue;
}
...
IkReal x1086=((0.613)*cj1);
evalcond[0]=((((-1.0)*x1080))+x1076+x1079+x1075);
evalcond[1]=(x1081+x1082+x1084+(((-1.0)*x1085)));
evalcond[2]=((((0.571)*x1080))+(((-1.0)*(1.0)*px))+(((-0.12)*x1076))+(((-0.571)*x1079))+((x1077*x1086))+(((-0.174)*x1083))+(((-0.12)*x1075)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((0.571)*x1085))+(((0.174)*x1077))+(((-0.12)*x1082))+((x1083*x1086))+(((-0.12)*x1081))+(((-0.571)*x1084)));
...
IkReal x1170=((0.613)*cj1);
IkReal x1171=((0.571)*cj1*cj2);
...
evalcond[6]=((((-1.0)*(1.0)*px))+(((-0.571)*x1160))+(((-0.12)*x1158))+(((-0.12)*x1157))+(((-0.174)*x1155))+((x1151*x1171))+((x1151*x1170)));
evalcond[7]=((((-0.571)*x1165))+(((-1.0)*(1.0)*py))+((x1155*x1170))+((x1155*x1171))+(((-0.12)*x1163))+(((0.174)*x1151))+(((-0.12)*x1164)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1187=((0.613)*cj1);
evalcond[0]=((((-1.0)*x1181))+x1177+x1176+x1180);
evalcond[1]=((((-1.0)*x1186))+x1185+x1182+x1183);
evalcond[2]=((((-1.0)*(1.0)*px))+((x1178*x1187))+(((-0.174)*x1184))+(((-0.12)*x1177))+(((-0.12)*x1176))+(((0.571)*x1181))+(((-0.571)*x1180)));
evalcond[3]=((((-0.12)*x1182))+(((-1.0)*(1.0)*py))+((x1184*x1187))+(((-0.12)*x1183))+(((0.174)*x1178))+(((0.571)*x1186))+(((-0.571)*x1185)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1247=((500.0)*px);
IkReal x1248=((306.5)*cj1);
IkReal x1249=(cj5*r01);
IkReal x1250=(r00*sj5);
IkReal x1251=((345.5)*cj1*cj2);
IkReal x1252=((345.5)*sj1*sj2);
CheckValue<IkReal> x1253=IKPowWithIntegerCheck(((((87.0)*x1246))+(((-87.0)*x1245))),-1);
if(!x1253.valid){
continue;
}
...
IkReal x1266=((0.613)*cj1);
evalcond[0]=((((-1.0)*x1260))+x1259+(((-1.0)*x1255))+(((-1.0)*x1256)));
evalcond[1]=((((-1.0)*x1261))+(((-1.0)*x1262))+(((-1.0)*x1265))+x1264);
evalcond[2]=((((-1.0)*(1.0)*px))+(((0.571)*x1260))+(((-0.12)*x1256))+(((-0.12)*x1255))+(((-0.571)*x1259))+((x1257*x1266))+(((-0.174)*x1263)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-0.12)*x1261))+(((-0.12)*x1262))+(((-0.571)*x1264))+(((0.571)*x1265))+((x1263*x1266))+(((0.174)*x1257)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1352=((0.613)*cj1);
IkReal x1353=((0.571)*cj1*cj2);
...
evalcond[6]=(((x1334*x1352))+(((-1.0)*(1.0)*px))+((x1334*x1353))+(((-0.571)*x1343))+(((-0.12)*x1340))+(((-0.174)*x1338))+(((-0.12)*x1341)));
evalcond[7]=((((-0.12)*x1347))+(((-1.0)*(1.0)*py))+((x1338*x1353))+(((-0.571)*x1348))+((x1338*x1352))+(((0.174)*x1334))+(((-0.12)*x1346)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1367=((0.613)*cj1);
evalcond[0]=((((-1.0)*x1357))+(((-1.0)*x1361))+(((-1.0)*x1356))+x1360);
evalcond[1]=((((-1.0)*x1363))+(((-1.0)*x1362))+x1365+(((-1.0)*x1366)));
evalcond[2]=((((-0.12)*x1357))+(((-1.0)*(1.0)*px))+(((-0.12)*x1356))+((x1358*x1367))+(((-0.174)*x1364))+(((-0.571)*x1360))+(((0.571)*x1361)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-0.571)*x1365))+(((-0.12)*x1363))+((x1364*x1367))+(((0.174)*x1358))+(((0.571)*x1366))+(((-0.12)*x1362)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1432=((306.5)*cj1);
IkReal x1433=(cj5*r01);
IkReal x1434=((500.0)*px);
IkReal x1435=(r00*sj5);
IkReal x1436=((60.0)*cj1*sj2);
IkReal x1437=((60.0)*cj2*sj1);
IkReal x1438=((285.5)*(IKcos((j1+j2))));
CheckValue<IkReal> x1439=IKPowWithIntegerCheck(((((-87.0)*x1430))+(((-87.0)*x1431))),-1);
if(!x1439.valid){
continue;
}
...
IkReal x1449=((0.613)*cj1);
IkReal x1450=((0.571)*(IKcos((j1+j2))));
evalcond[0]=((((-1.0)*x1443*x1444))+x1441+x1442+(((-1.0)*x1443*x1445)));
evalcond[1]=((((-1.0)*x1444*x1448))+(((-1.0)*x1445*x1448))+x1447+x1446);
evalcond[2]=((((-1.0)*(1.0)*px))+(((-0.12)*x1442))+((x1443*x1449))+(((-0.12)*x1441))+((x1443*x1450))+(((-0.174)*x1448)));
evalcond[3]=((((-1.0)*(1.0)*py))+((x1448*x1450))+(((0.174)*x1443))+((x1448*x1449))+(((-0.12)*x1447))+(((-0.12)*x1446)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1535=((0.613)*cj1);
IkReal x1536=((0.571)*x1534);
...
evalcond[6]=((((-1.0)*(1.0)*px))+(((-0.12)*x1525))+((x1519*x1535))+((x1519*x1536))+(((-0.12)*x1526))+(((-0.174)*x1523)));
evalcond[7]=((((-1.0)*(1.0)*py))+((x1523*x1536))+((x1523*x1535))+(((-0.12)*x1531))+(((0.174)*x1519))+(((-0.12)*x1530)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1549=((0.613)*cj1);
IkReal x1550=((0.571)*(IKcos((j1+j2))));
evalcond[0]=((((-1.0)*x1543*x1545))+x1542+x1541+(((-1.0)*x1543*x1544)));
evalcond[1]=((((-1.0)*x1545*x1548))+x1547+x1546+(((-1.0)*x1544*x1548)));
evalcond[2]=((((-0.174)*x1548))+(((-1.0)*(1.0)*px))+(((-0.12)*x1542))+((x1543*x1550))+(((-0.12)*x1541))+((x1543*x1549)));
evalcond[3]=((((-0.12)*x1547))+(((-1.0)*(1.0)*py))+((x1548*x1549))+((x1548*x1550))+(((-0.12)*x1546))+(((0.174)*x1543)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1613=((306.5)*cj1);
IkReal x1614=(cj5*r01);
IkReal x1615=((500.0)*px);
IkReal x1616=(r00*sj5);
IkReal x1617=((60.0)*cj1*sj2);
IkReal x1618=((60.0)*cj2*sj1);
IkReal x1619=((285.5)*(IKcos((j1+j2))));
CheckValue<IkReal> x1620=IKPowWithIntegerCheck(((((-87.0)*x1611))+(((-87.0)*x1612))),-1);
if(!x1620.valid){
continue;
}
...
IkReal x1630=((0.613)*cj1);
IkReal x1631=((0.571)*(IKcos((j1+j2))));
...
evalcond[2]=((((-1.0)*(1.0)*px))+(((-0.12)*x1622))+(((-0.12)*x1623))+((x1624*x1630))+((x1624*x1631))+(((-0.174)*x1629)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-0.12)*x1627))+(((0.174)*x1624))+(((-0.12)*x1628))+((x1629*x1630))+((x1629*x1631)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1713=((0.613)*cj1);
IkReal x1714=((0.571)*x1712);
...
evalcond[6]=((((-1.0)*(1.0)*px))+((x1696*x1713))+(((-0.12)*x1703))+(((-0.174)*x1700))+((x1696*x1714))+(((-0.12)*x1702)));
evalcond[7]=((((-1.0)*(1.0)*py))+(((-0.12)*x1708))+(((-0.12)*x1707))+(((0.174)*x1696))+((x1700*x1713))+((x1700*x1714)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[5]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[6]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[7]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1725=((0.613)*cj1);
IkReal x1726=((0.571)*(IKcos((j1+j2))));
...
evalcond[2]=((((-1.0)*(1.0)*px))+(((-0.12)*x1718))+((x1719*x1726))+(((-0.12)*x1717))+(((-0.174)*x1724))+((x1719*x1725)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-0.12)*x1723))+((x1724*x1725))+(((-0.12)*x1722))+(((0.174)*x1719))+((x1724*x1726)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1779=((153250.0)*cj1);
IkReal x1780=((5220.0)*cj5);
IkReal x1781=((5220.0)*sj5);
IkReal x1782=((142750.0)*cj1*cj2);
IkReal x1783=((18390.0)*cj1*cj5);
IkReal x1784=((18390.0)*cj1*sj5);
IkReal x1785=((142750.0)*sj1*sj2);
IkReal x1786=((17130.0)*cj1*cj2*cj5);
IkReal x1787=((17130.0)*cj1*cj2*sj5);
IkReal x1788=((17130.0)*cj5*sj1*sj2);
IkReal x1789=((17130.0)*sj1*sj2*sj5);
CheckValue<IkReal> x1790 = IKatan2WithCheck(IkReal((((r11*x1783))+((py*x1782))+(((-1.0)*r10*x1789))+(((-1.0)*r00*x1781))+((py*x1779))+(((-1.0)*r11*x1788))+((r10*x1784))+((r10*x1787))+((r11*x1786))+(((-1.0)*r01*x1780))+(((-1.0)*py*x1785))+(((-1.0)*(43500.0)*px)))),IkReal((((r01*x1786))+((px*x1782))+((px*x1779))+((r00*x1784))+(((-1.0)*px*x1785))+((r11*x1780))+(((-1.0)*r01*x1788))+((r01*x1783))+(((43500.0)*py))+(((-1.0)*r00*x1789))+((r10*x1781))+((r00*x1787)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1790.valid){
continue;
}
CheckValue<IkReal> x1791=IKPowWithIntegerCheck(IKsign(((89079.25)+(((-163020.5)*cj2*x1778))+(((-175011.5)*x1778))+(((12432.0)*x1776))+(((163020.5)*x1776*x1777))+(((-81510.25)*x1777))+(((175011.5)*cj2*x1776)))),-1);
if(!x1791.valid){
continue;
}
...
{
IkReal evalcond[2];
IkReal x1792=((0.12)*cj5);
IkReal x1793=((0.12)*sj5);
IkReal x1794=IKsin(j0);
IkReal x1795=IKcos(j0);
IkReal x1796=((0.613)*cj1);
IkReal x1797=((0.571)*cj1*cj2);
IkReal x1798=((0.571)*sj1*sj2);
evalcond[0]=((((-0.174)*x1794))+(((-1.0)*(1.0)*px))+(((-1.0)*x1795*x1798))+(((-1.0)*r00*x1793))+((x1795*x1797))+((x1795*x1796))+(((-1.0)*r01*x1792)));
evalcond[1]=((((-1.0)*(1.0)*py))+(((-1.0)*x1794*x1798))+(((-1.0)*r11*x1792))+((x1794*x1796))+(((-1.0)*r10*x1793))+(((0.174)*x1795))+((x1794*x1797)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x2891=((0.12)*cj5);
IkReal x2892=((0.12)*sj5);
IkReal x2893=((0.613)*cj1);
IkReal x2894=((0.571)*cj1*cj2);
...
evalcond[2]=(((x2885*x2894))+(((-1.0)*(1.0)*px))+(((-0.571)*x2896))+(((-1.0)*r01*x2891))+((x2885*x2893))+(((-1.0)*r00*x2892))+(((-0.174)*x2889)));
evalcond[3]=((((-0.571)*x2897))+((x2889*x2894))+(((-1.0)*(1.0)*py))+(((0.174)*x2885))+((x2889*x2893))+(((-1.0)*r11*x2891))+(((-1.0)*r10*x2892)));
...
IkReal x2942=((0.12)*cj5);
IkReal x2943=((0.12)*sj5);
IkReal x2944=((0.613)*cj1);
IkReal x2945=((0.571)*cj1*cj2);
...
evalcond[2]=((((-1.0)*(1.0)*px))+(((-0.571)*x2947))+(((-1.0)*r00*x2943))+((x2936*x2945))+((x2936*x2944))+(((-1.0)*r01*x2942))+(((-0.174)*x2940)));
evalcond[3]=((((-1.0)*(1.0)*py))+(((-1.0)*r10*x2943))+(((-0.571)*x2948))+(((-1.0)*r11*x2942))+((x2940*x2945))+((x2940*x2944))+(((0.174)*x2936)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - ur10e (b7af3bd85ebaa63bd20d64ed3a04142b)>"; }
